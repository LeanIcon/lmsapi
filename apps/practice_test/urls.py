...
from .views import MyQuizListAPI, QuizListAPI, QuizDetailAPI, SaveUsersAnswer, SubmitQuizAPI, QuizResultAPI, QuizCategoryViewSet
...
urlpatterns = [
	...
	path("category/", QuizCategoryViewSet.as_view()),
